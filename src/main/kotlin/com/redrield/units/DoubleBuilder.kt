...
import com.redrield.units.derived.*
 ...
 */
val Double.gram get() = SIUnit<Kilogram>(toDouble() / 1000.0)
val Double.second get() = SIUnit<Second>(toDouble())
val Double.amp get() = SIUnit<Ampere>(toDouble())
val Double.coulomb get() = SIUnit<Coulomb>(toDouble())
val Double.volt get() = SIUnit<Volt>(toDouble())
val Double.ohm get() = SIUnit<Ohm>(toDouble())
val Double.newton get() = SIUnit<Newton>(toDouble())
val Double.joule get() = SIUnit<Joule>(toDouble())
val Double.hertz get() = SIUnit<Hertz>(toDouble())
val Double.curvature get() = SIUnit<Curvature>(toDouble())
val Double.meter get() = SIUnit<Meter>(toDouble())

val Double.radian get() = SIUnit<Radian>(toDouble())
val Double.degree get() = SIUnit<Radian>(Math.toRadians(toDouble()))