 ...
 */
val Float.gram get() = SIUnit<Kilogram>(toDouble() / 1000.0)
val Float.second get() = SIUnit<Second>(toDouble())
val Float.amp get() = SIUnit<Ampere>(toDouble())
val Float.coulomb get() = SIUnit<Coulomb>(toDouble())
val Float.volt get() = SIUnit<Volt>(toDouble())
val Float.ohm get() = SIUnit<Ohm>(toDouble())
val Float.newton get() = SIUnit<Newton>(toDouble())
val Float.joule get() = SIUnit<Joule>(toDouble())
val Float.hertz get() = SIUnit<Hertz>(toDouble())
val Float.curvature get() = SIUnit<Curvature>(toDouble())
val Float.meter get() = SIUnit<Meter>(toDouble())

val Float.radian get() = SIUnit<Radian>(toDouble())
val Float.degree get() = SIUnit<Radian>(Math.toRadians(toDouble()))