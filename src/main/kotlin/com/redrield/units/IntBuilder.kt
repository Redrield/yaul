 ...
 */
val Int.gram get() = SIUnit<Kilogram>(toDouble() / 1000.0)
val Int.second get() = SIUnit<Second>(toDouble())
val Int.amp get() = SIUnit<Ampere>(toDouble())
val Int.coulomb get() = SIUnit<Coulomb>(toDouble())
val Int.volt get() = SIUnit<Volt>(toDouble())
val Int.ohm get() = SIUnit<Ohm>(toDouble())
val Int.newton get() = SIUnit<Newton>(toDouble())
val Int.joule get() = SIUnit<Joule>(toDouble())
val Int.hertz get() = SIUnit<Hertz>(toDouble())
val Int.curvature get() = SIUnit<Curvature>(toDouble())
val Int.meter get() = SIUnit<Meter>(toDouble())

val Int.radian get() = SIUnit<Radian>(toDouble())
val Int.degree get() = SIUnit<Radian>(Math.toRadians(toDouble()))