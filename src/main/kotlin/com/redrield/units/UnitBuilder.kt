...
class UnitBuilder internal constructor(val value: Double, val prefixScalar: Double) {
    ...
    val curvature get() = SIUnit<Curvature>(value * prefixScalar)
...
val <T : Key> SIUnit<T>.velocity get() = SIUnit<Velocity<T>>(value)
val <T : Key> SIUnit<T>.acceleration get() = SIUnit<Acceleration<T>>(value)
